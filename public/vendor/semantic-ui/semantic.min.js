...
!function (e, t, n, i) {
    ...
    e.fn.form = function (t, o) {
        ...
        return r.each(function () {
            var t, o = e(this), l = e(this).find(d.field), w = e(this).find(d.group), C = e(this).find(d.message), T = (e(this).find(d.prompt), e(this).find(d.submit)), k = [], S = this, z = o.data(g);
            t = {
                initialize: function () {
                    t.verbose("Initializing form validation", o, c, s), t.bindEvents(), t.instantiate()
                }, instantiate: function () {
                    t.verbose("Storing instance of module", t), z = t, o.data(g, t)
                }, destroy: function () {
                    t.verbose("Destroying previous module", z), t.removeEvents(), o.removeData(g)
                }, refresh: function () {
                    ...
                    form: function (n) {
                        ...
                        }), a ? (t.debug("Form has no validation errors, submitting"), t.set.success(), e.proxy(s.onSuccess, S)(n)) : (t.debug("Form has errors"), t.set.error(), s.inline || t.add.errors(k), o.data("moduleApi") !== i && n.stopImmediatePropagation(), e.proxy(s.onFailure, S)(k))
                    }, field: function (n) {
                        ...
                        return m !== i && null !== m ? (a = "" + m[1], r = l.replace(m[0], ""), f = e.proxy(s.rules[r], S)(u, a)) : f = e.proxy(s.rules[l], c)(u), f
                    }
            ...
            }, y ? (z === i && t.initialize(), t.invoke(h)) : (z !== i && t.destroy(), t.initialize())
        }), a !== i ? a : this
    }, e.fn.form.settings = {
        name: "Form",
        namespace: "form",
        ...
        className: {error: "error", success: "success", down: "down", label: "ui prompt label"},
    ...
    e.fn.accordion = function (n) {
        ...
        return a.each(function () {
            var d, m, f = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.accordion.settings, n) : e.extend({}, e.fn.accordion.settings), g = f.className, p = f.namespace, b = f.selector, v = f.error, h = "." + p, y = "module-" + p, x = a.selector || "", w = e(this), C = w.find(b.title), T = w.find(b.content), k = this, S = w.data(y);
            m = {
                initialize: function () {
                    m.debug("Initializing accordion with bound events", w), w.on("click" + h, b.title, m.event.click), m.observeChanges(), m.instantiate()
                }, instantiate: function () {
                    S = m, w.data(y, m)
                }, destroy: function () {
                    m.debug("Destroying previous accordion for", w), w.removeData(y), C.off(h)
                }, refresh: function () {
                    C = w.find(b.title), T = w.find(b.content)
                    ...
                    a || r || (m.debug("Opening accordion content", n), f.exclusive && e.proxy(m.closeOthers, n)(), n.addClass(g.active), f.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        animation: "fade in",
                        useFailSafe: !0,
                        debug: f.debug,
                        verbose: f.verbose,
                        duration: f.duration
                    }) : o.children().stop().animate({opacity: 1}, f.duration, m.resetOpacity)), o.stop().slideDown(f.duration, f.easing, function () {
                    ...
                    a && (m.debug("Closing accordion content", o), n.removeClass(g.active), o.removeClass(g.active).show(), f.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        ...
                        verbose: f.verbose,
                        duration: f.duration
                    }) : o.children().stop().animate({opacity: 0}, f.duration, m.resetOpacity)), o.stop().slideUp(f.duration, f.easing, function () {
                        e.proxy(m.reset.display, this)(), e.proxy(f.onClose, this)(), e.proxy(f.onChange, this)()
                    }))
                }, closeOthers: function (t) {
                    var n, o, a, r = t !== i ? C.eq(t) : e(this), s = r.parents(b.content).prev(b.title), c = r.closest(b.accordion), l = b.title + "." + g.active + ":visible", u = b.content + "." + g.active + ":visible";
                    f.closeNested ? (n = c.find(l).not(s), a = n.next(T)) : (n = c.find(l).not(s), o = c.find(u).find(l).not(s), n = n.not(o), a = n.next(T)), n.size() > 0 && (m.debug("Exclusive enabled, closing other content", n), n.removeClass(g.active), f.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? a.children().transition({
                        animation: "fade out",
                        useFailSafe: !0,
                        debug: f.debug,
                        verbose: f.verbose,
    ...
    e.fn.checkbox = function (n) {
        ...
        return a.each(function () {
            var a, m, f = e.extend(!0, {}, e.fn.checkbox.settings, n), g = f.className, p = f.namespace, b = f.selector, v = f.error, h = "." + p, y = "module-" + p, x = e(this), w = e(this).find(b.label).first(), C = e(this).find(b.input), T = x.data(y), k = this;
            m = {
                initialize: function () {
                    m.verbose("Initializing checkbox", f), m.create.label(), m.add.events(), m.is.checked() ? (m.set.checked(), f.fireOnInit && e.proxy(f.onChecked, C.get())()) : (m.remove.checked(), f.fireOnInit && e.proxy(f.onUnchecked, C.get())()), m.observeChanges(), m.instantiate()
                }, instantiate: function () {
                    m.verbose("Storing instance of module", m), T = m, x.data(y, m)
                }, destroy: function () {
                    m.verbose("Destroying module"), m.remove.events(), x.removeData(y)
                }, refresh: function () {
                    x = e(this), w = e(this).find(b.label).first(), C = e(this).find(b.input)
                }, observeChanges: function () {
                    ...
                    label: function () {
                        C.prevAll(b.label).size() > 0 ? (C.prev(b.label).detach().insertAfter(C), m.debug("Moving existing label", w)) : m.has.label() || (w = e("<label>").insertAfter(C), m.debug("Creating label", w))
                    }
                }, has: {
                    label: function () {
                        return w.size() > 0
                    ...
                    events: function () {
                        m.verbose("Attaching checkbox events"), x.on("click" + h, m.toggle).on("keydown" + h, b.input, m.event.keydown)
                    }
                }, remove: {
                    checked: function () {
                        x.removeClass(g.checked)
                    }, events: function () {
                        m.debug("Removing events"), x.off(h).removeData(y), C.off(h, m.event.keydown), w.off(h)
                    }
                }, enable: function () {
    ...
    e.fn.dimmer = function (t) {
        var o, a = e(this), r = (new Date).getTime(), s = [], c = arguments[0], l = "string" == typeof c, u = [].slice.call(arguments, 1);
        return a.each(function () {
            var d, m, f, g = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.dimmer.settings, t) : e.extend({}, e.fn.dimmer.settings), p = g.selector, b = g.namespace, v = g.className, h = g.error, y = "." + b, x = "module-" + b, w = a.selector || "", C = "ontouchstart"in n.documentElement ? "touchstart" : "click", T = e(this), k = this, S = T.data(x);
            f = {
                preinitialize: function () {
                    ...
                    }, f.debug("Showing dimmer", d, g), f.is.dimmed() && !f.is.animating() || !f.is.enabled() ? f.debug("Dimmer is already shown or disabled") : (f.animate.show(t), e.proxy(g.onShow, k)(), e.proxy(g.onChange, k)())
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, f.is.dimmed() || f.is.animating() ? (f.debug("Hiding dimmer", d), f.animate.hide(t), e.proxy(g.onHide, k)(), e.proxy(g.onChange, k)()) : f.debug("Dimmer is not visible")
                }, toggle: function () {
                    ...
                    dimmer: function () {
                        return g.dimmerName ? T.children(p.dimmer).filter("." + g.dimmerName).size() > 0 : T.children(p.dimmer).size() > 0
                    }
                }, is: {
                    active: function () {
                    ...
                    log: function (e) {
                        ...
                        r = !1, clearTimeout(f.performance.timer), e.each(s, function (e, t) {
                            n += t["Execution Time"]
                        }), t += " " + n + "ms", w && (t += " '" + w + "'"), a.size() > 1 && (t += " (" + a.size() + ")"), (console.group !== i || console.table !== i) && s.length > 0 && (console.groupCollapsed(t), console.table ? console.table(s) : e.each(s, function (e, t) {
                            console.log(t.Name + ": " + t["Execution Time"] + "ms")
                        }), console.groupEnd()), s = []
                    }
                }, invoke: function (t, n, a) {
    ...
    e.fn.dropdown = function (o) {
        ...
        return r.each(function () {
            var p, b, v, h, y = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings), x = y.className, w = y.metadata, C = y.namespace, T = y.selector, k = y.error, S = "." + C, z = "module-" + C, A = e(this), P = A.find(T.text), E = A.find(T.search), F = A.find(T.input), D = A.prev().find(T.text).size() > 0 ? A.prev().find(T.text) : A.prev(), O = A.children(T.menu), R = O.find(T.item), j = !1, q = !1, N = this, I = A.data(z);
            h = {
                initialize: function () {
                    h.debug("Initializing dropdown", y), h.setup.layout(), h.save.defaults(), h.set.selected(), h.create.id(), l && h.bind.touchEvents(), h.bind.mouseEvents(), h.bind.keyboardEvents(), h.observeChanges(), h.instantiate()
                }, instantiate: function () {
                    h.verbose("Storing instance of dropdown", h), I = h, A.data(z, h)
                }, destroy: function () {
                    h.verbose("Destroying previous dropdown for", A), h.remove.tabbable(), A.off(S).removeData(z), s.off(p)
                }, observeChanges: function () {
                    "MutationObserver"in t && (v = new MutationObserver(function () {
                        h.debug("DOM tree modified, updating selector cache"), h.refresh()
                    }), v.observe(N, {childList: !0, subtree: !0}), h.debug("Setting up mutation observer", v))
                }, create: {
                    id: function () {
                        h.verbose("Creating unique id for element"), b = h.get.uniqueID(), p = "." + b
                    }
                }, search: function () {
                    var e;
                    e = E.val(), h.verbose("Searching for query", e), h.is.searchSelection() && (h.filter(e), h.can.show() && h.show())
                }, setup: {
                    layout: function () {
                        A.is("select") && h.setup.select(), h.is.search() && !h.is.searchable() && (E = e("<input />").addClass(x.search).insertBefore(P)), y.allowTab && h.set.tabbable()
                    }, select: function () {
                        var t = h.get.selectValues();
                        h.debug("Dropdown initialized on a select", t), F = A, F.parents(T.dropdown).size() > 0 ? (h.debug("Creating dropdown menu only from template"), A = F.closest(T.dropdown), 0 === A.find("." + x.dropdown).size() && e("<div />").addClass(x.menu).html(y.templates.menu(t)).appendTo(A)) : (h.debug("Creating entire dropdown from template"), A = e("<div />").attr("class", F.attr("class")).addClass(x.selection).addClass(x.dropdown).html(y.templates.dropdown(t)).insertBefore(F), F.removeAttr("class").prependTo(A)), h.refresh()
                    }
                }, refresh: function () {
                    P = A.find(T.text), E = A.find(T.search), F = A.find(T.input), O = A.children(T.menu), R = O.find(T.item)
                }, toggle: function () {
                    h.verbose("Toggling menu visibility"), h.is.active() ? h.hide() : h.show()
                }, show: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, h.is.active() || h.is.allFiltered() || (h.debug("Showing dropdown"), h.animate.show(function () {
                        h.can.click() && h.bind.intent(), h.set.visible(), e.proxy(t, N)()
                    }), e.proxy(y.onShow, N)())
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, h.is.active() && (h.debug("Hiding dropdown"), h.animate.hide(function () {
                        h.remove.visible(), e.proxy(t, N)()
                    }), e.proxy(y.onHide, N)())
                }, hideOthers: function () {
                    h.verbose("Finding other dropdowns to hide"), r.not(A).has(T.menu + ":visible:not(." + x.animating + ")").dropdown("hide")
                }, hideSubMenus: function () {
                    var e = O.find(T.menu);
                    e.transition("hide")
                }, bind: {
                    keyboardEvents: function () {
                        h.debug("Binding keyboard events"), A.on("keydown" + S, h.event.keydown), h.is.searchable() && A.on(h.get.inputEvent(), T.search, h.event.input)
                    }, touchEvents: function () {
                        h.debug("Touch device detected binding additional touch events"), h.is.searchSelection() || A.on("touchstart" + S, h.event.test.toggle), O.on("touchstart" + S, T.item, h.event.item.mouseenter)
                        ...
                        h.verbose("Binding hide intent event to document"), l && s.on("touchstart" + p, h.event.test.touch).on("touchmove" + p, h.event.test.touch), s.on("click" + p, h.event.test.hide)
                    }
                }, unbind: {
                    intent: function () {
                        h.verbose("Removing hide intent event from document"), l && s.off("touchstart" + p).off("touchmove" + p), s.off("click" + p)
                    }
                }, filter: function (t) {
                    var n = e(), i = new RegExp("^" + t, "igm"), o = new RegExp(t, "ig");
                    h.verbose("Searching for matching values"), R.each(function () {
                        var t = e(this), a = h.get.choiceText(t, !1), r = h.get.choiceValue(t, a);
                        a.match(i) || r.match(i) ? n = n.add(t) : y.fullTextSearch && (a.match(o) || r.match(o)) && (n = n.add(t))
                    }), h.debug("Setting filter", t), h.remove.filteredItem(), R.not(n).addClass(x.filtered), h.verbose("Selecting first non-filtered element"), h.remove.selectedItem(), R.not("." + x.filtered).eq(0).addClass(x.selected), h.is.allFiltered() && (h.debug("All items filtered, hiding dropdown", t), h.hide(), e.proxy(y.onNoResults, N)(t))
                    ...
                    mousedown: function () {
                        ...
                        h.set.filtered(), clearTimeout(h.timer), h.timer = setTimeout(h.search, y.delay.search)
                    }, keydown: function (t) {
                        var n, i = R.not(x.filtered).filter("." + x.selected).eq(0), o = R.not("." + x.filtered), a = t.which, r = {
                            enter: 13,
                            escape: 27,
                            upArrow: 38,
                            downArrow: 40
                        }, s = x.selected, c = o.index(i), l = i.size() > 0;
                        if (l || (i = R.filter("." + x.active).eq(0), l = i.size() > 0), a == r.escape && (h.verbose("Escape key pressed, closing dropdown"), h.hide()), a == r.downArrow && (h.verbose("Down key pressed, showing dropdown"), h.show()), h.is.visible()) {
                            if (a == r.enter && l)return h.verbose("Enter key pressed, choosing selected item"), e.proxy(h.event.item.click, i)(t), t.preventDefault(), !1;
                            a == r.upArrow ? (n = l ? i.prevAll(T.item + ":not(." + x.filtered + ")").eq(0) : o.eq(0), 0 !== c && (h.verbose("Up key pressed, changing active item"), R.removeClass(s), n.addClass(s), h.set.scrollPosition(n)), t.preventDefault()) : a == r.downArrow && (n = l ? i.nextAll(T.item + ":not(." + x.filtered + ")").eq(0) : o.eq(0), c + 1 < o.size() && (h.verbose("Down key pressed, changing active item"), R.removeClass(s), n.addClass(s), h.set.scrollPosition(n)), t.preventDefault())
                        } else a == r.enter && h.show()
                    }, test: {
                        toggle: function (e) {
                            h.determine.eventInMenu(e, h.toggle) && e.preventDefault()
                        }, touch: function (e) {
                            h.determine.eventInMenu(e, function () {
                                "touchstart" == e.type ? h.timer = setTimeout(h.hide, y.delay.touch) : "touchmove" == e.type && clearTimeout(h.timer)
                            }), e.stopPropagation()
                        }, hide: function (e) {
                        ...
                        mouseenter: function (t) {
                            ...
                            var n = e(this), i = e(t.target), o = n.find(T.menu), a = h.get.choiceText(n), r = h.get.choiceValue(n, a), s = function () {
                                h.remove.searchTerm(), h.determine.selectAction(a, r)
                            }, c = o.size() > 0, l = o.find(i).size() > 0;
                    ...
                    selectAction: function (t, n) {
                        h.verbose("Determining action", y.action), e.isFunction(h.action[y.action]) ? (h.verbose("Triggering preset action", y.action, t, n), h.action[y.action](t, n)) : e.isFunction(y.action) ? (h.verbose("Triggering user action", y.action, t, n), y.action(t, n)) : h.error(k.action, y.action)
                    }, eventInModule: function (t, n) {
                        return n = e.isFunction(n) ? n : function () {
                        }, 0 === e(t.target).closest(A).size() ? (h.verbose("Triggering event", n), n(), !0) : (h.verbose("Event occurred in dropdown, canceling callback"), !1)
                    }, eventInMenu: function (t, n) {
                        return n = e.isFunction(n) ? n : function () {
                        }, 0 === e(t.target).closest(O).size() ? (h.verbose("Triggering event", n), n(), !0) : (h.verbose("Event occurred in dropdown menu, canceling callback"), !1)
                    }
                }, action: {
                    nothing: function () {
                    }, hide: function () {
                        ...
                        t = t !== i ? t : e, h.set.selected(t), h.set.value(t), h.hide(function () {
                            h.remove.filteredItem()
                        })
                    ...
                    text: function () {
                        ...
                        return F.size() > 0 ? F.val() : A.data(w.value)
                    }, choiceText: function (e, t) {
                        return t = t !== i ? t : y.preserveHTML, e !== i ? (e.find(T.menu).size() > 0 && (h.verbose("Retreiving text of element with sub-menu"), e = e.clone(), e.find(T.menu).remove(), e.find(T.menuIcon).remove()), e.data(w.text) !== i ? e.data(w.text) : t ? e.html() : e.text()) : void 0
                    }, choiceValue: function (e, t) {
                        return t = t || h.get.choiceText(P), e.data(w.value) !== i ? e.data(w.value) : "string" == typeof t ? t.toLowerCase() : t
                    }, inputEvent: function () {
                        var e = E[0];
                        ...
                        }), y.sortSelect ? h.debug("Retrieved and sorted values from select", t) : h.debug("Retreived values from select", t), t
                    }, activeItem: function () {
                        return R.filter("." + x.active)
                    }, item: function (t, n) {
                        var o = !1;
                        return t = t !== i ? t : h.get.value() !== i ? h.get.value() : h.get.text(), n = "" === t || 0 === t ? !0 : n || !1, t !== i ? R.each(function () {
                            var i = e(this), a = h.get.choiceText(i), r = h.get.choiceValue(i, a);
                            n ? (h.verbose("Ambiguous dropdown value using strict type check", i, t), r === t ? o = e(this) : o || a !== t || (o = e(this))) : r == t ? (h.verbose("Found select item by value", r, t), o = e(this)) : o || a != t || (h.verbose("Found select item by text", a, t), o = e(this))
                        }) : t = h.get.text(), o || !1
                    }, uniqueID: function () {
                    ...
                    defaults: function () {
                        ...
                        var e = A.data(w.defaultText);
                        h.debug("Restoring default text", e), h.set.text(e)
                    }, defaultValue: function () {
                        var e = A.data(w.defaultValue);
                    ...
                    defaults: function () {
                        ...
                        A.data(w.defaultValue, h.get.value())
                    }, defaultText: function () {
                        A.data(w.defaultText, P.text())
                    }
                }, set: {
                    filtered: function () {
                        var e = E.val(), t = "string" == typeof e && e.length > 0;
                        t ? P.addClass(x.filtered) : P.removeClass(x.filtered)
                    }, tabbable: function () {
                        h.is.searchable() ? (h.debug("Searchable dropdown initialized"), E.val("").attr("tabindex", 0), O.attr("tabindex", "-1")) : (h.debug("Simple selection dropdown initialized"), A.attr("tabindex") || (A.attr("tabindex", 0), O.attr("tabindex", "-1")))
                    }, scrollPosition: function (e, t) {
                        var n, o, a, r, s, c, l, u, d, m = 5;
                        e = e || h.get.activeItem(), n = e && e.size() > 0, t = t !== i ? t : !1, e && n && (O.hasClass(x.visible) || O.addClass(x.loading), l = O.height(), a = e.height(), c = O.scrollTop(), s = O.offset().top, r = e.offset().top, o = c - s + r, d = o + m > c + l, u = c > o - m, h.debug("Scrolling to active item", o), (u || d || t) && O.scrollTop(o).removeClass(x.loading))
                    }, text: function (e) {
                        "combo" == y.action ? (h.debug("Changing combo button text", e, D), y.preserveHTML ? D.html(e) : D.text(e)) : "select" !== y.action && (h.debug("Changing text", e, P), P.removeClass(x.filtered).removeClass(x.placeholder), y.preserveHTML ? P.html(e) : P.text(e))
                    }, value: function (e) {
                        h.debug("Adding selected value to hidden input", e, F), F.size() > 0 ? F.val(e).trigger("change") : A.data(w.value, e)
                    }, active: function () {
                        A.addClass(x.active)
                    }, visible: function () {
                        A.addClass(x.visible)
                    }, selected: function (t) {
                        var n, i = h.get.item(t);
                        i && (h.debug("Setting selected menu item to", i), h.remove.activeItem(), h.remove.selectedItem(), i.addClass(x.active).addClass(x.selected), n = h.get.choiceText(i), h.set.text(n), e.proxy(y.onChange, N)(t, n, i))
                    }
                }, remove: {
                    active: function () {
                        ...
                        R.removeClass(x.filtered)
                    }, searchTerm: function () {
                        E.val("")
                    }, selectedItem: function () {
                        R.removeClass(x.selected)
                    }, tabbable: function () {
                        h.is.searchable() ? (h.debug("Searchable dropdown initialized"), E.attr("tabindex", "-1"), O.attr("tabindex", "-1")) : (h.debug("Simple selection dropdown initialized"), A.attr("tabindex", "-1"), O.attr("tabindex", "-1"))
                    }
                }, is: {
                    active: function () {
                        ...
                        return R.filter("." + x.filtered).size() === R.size()
                    }, hidden: function (e) {
                        ...
                        return h.is.searchable() && E.parent().is(A)
                    }, selection: function () {
                    ...
                    show: function (t, n) {
                        ...
                        t = e.isFunction(t) ? t : function () {
                        }, h.set.scrollPosition(h.get.activeItem(), !0), h.verbose("Doing menu show animation", o), (h.is.hidden(o) || h.is.animating(o)) && ("none" == y.transition ? e.proxy(t, N)() : e.fn.transition !== i && A.transition("is supported") ? o.transition({
                        ...
                        }) : "slide down" == y.transition ? (a(), o.hide().clearQueue().children().clearQueue().css("opacity", 0).delay(50).animate({opacity: 1}, y.duration, "easeOutQuad", h.event.resetStyle).end().slideDown(100, "easeOutQuad", function () {
                            e.proxy(h.event.resetStyle, this)(), e.proxy(t, N)()
                        })) : "fade" == y.transition ? (a(), o.hide().clearQueue().fadeIn(y.duration, function () {
                            e.proxy(h.event.resetStyle, this)(), e.proxy(t, N)()
                        })) : h.error(k.transition, y.transition))
                    }, hide: function (t, n) {
                        var o = n || O, a = (n ? .9 * y.duration : y.duration, n ? function () {
                        } : function () {
                            h.can.click() && h.unbind.intent(), h.focusSearch(), h.remove.active()
                        });
                        t = e.isFunction(t) ? t : function () {
                        }, (h.is.visible(o) || h.is.animating(o)) && (h.verbose("Doing menu hide animation", o), "none" == y.transition ? e.proxy(t, N)() : e.fn.transition !== i && A.transition("is supported") ? o.transition({
                        ...
                        }) : "slide down" == y.transition ? (a(), o.show().clearQueue().children().clearQueue().css("opacity", 1).animate({opacity: 0}, 100, "easeOutQuad", h.event.resetStyle).end().delay(50).slideUp(100, "easeOutQuad", function () {
                            e.proxy(h.event.resetStyle, this)(), e.proxy(t, N)()
                        })) : "fade" == y.transition ? (a(), o.show().clearQueue().fadeOut(150, function () {
                            e.proxy(h.event.resetStyle, this)(), e.proxy(t, N)()
                        })) : h.error(k.transition))
                    }
                }, delay: {
                    show: function () {
                        h.verbose("Delaying show event to ensure user intent"), clearTimeout(h.timer), h.timer = setTimeout(h.show, y.delay.show)
                    }, hide: function () {
                        h.verbose("Delaying hide event to ensure user intent"), clearTimeout(h.timer), h.timer = setTimeout(h.hide, y.delay.hide)
                    }
                }, setting: function (t, n) {
                    ...
                    y.debug && (y.performance ? h.performance.log(arguments) : (h.debug = Function.prototype.bind.call(console.info, console, y.name + ":"), h.debug.apply(console, arguments)))
                }, verbose: function () {
                    y.verbose && y.debug && (y.performance ? h.performance.log(arguments) : (h.verbose = Function.prototype.bind.call(console.info, console, y.name + ":"), h.verbose.apply(console, arguments)))
                }, error: function () {
                    h.error = Function.prototype.bind.call(console.error, console, y.name + ":"), h.error.apply(console, arguments)
                }, performance: {
                    log: function (e) {
                        var t, n, i;
                    ...
                    return n = n || g, o = N || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        ...
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
                            if (!e.isPlainObject(l[o]) || n == r)return l[o] !== i ? (s = l[o], !1) : (h.error(k.method, t), !1);
                            l = l[o]
                        }
                    })), e.isFunction(s) ? c = s.apply(o, n) : s !== i && (c = s), e.isArray(a) ? a.push(c) : a !== i ? a = [a, c] : c !== i && (a = c), s
                }
            }, f ? (I === i && h.initialize(), h.invoke(m)) : (I !== i && h.destroy(), h.initialize())
        }), a !== i ? a : this
    ...
    e.fn.modal = function (o) {
        ...
        return r.each(function () {
            var r, v, h, y, x, w, C, T, k, S = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings), z = S.selector, A = S.className, P = S.namespace, E = S.error, F = "." + P, D = "module-" + P, O = e(this), R = e(S.context), j = O.find(z.close), q = this, N = O.data(D);
            k = {
                initialize: function () {
                    k.verbose("Initializing dimmer", R), k.create.id(), k.create.dimmer(), k.refreshModals(), k.verbose("Attaching close events", j), k.bind.events(), k.observeChanges(), k.instantiate()
                }, instantiate: function () {
                    ...
                    dimmer: function () {
                        ...
                        return e.fn.dimmer === i ? void k.error(E.dimmer) : (k.debug("Creating dimmer with settings", n), y = R.dimmer(n), S.detachable && (k.verbose("Modal is detachable, moving content into dimmer"), y.dimmer("add content", O)), void(x = y.dimmer("get dimmer")))
                    }, id: function () {
                        k.verbose("Creating unique id for element"), C = k.get.uniqueID(), w = "." + C
                    }
                }, destroy: function () {
                    k.verbose("Destroying previous modal"), O.removeData(D).off(F), s.off(w), j.off(F), R.dimmer("destroy")
                }, observeChanges: function () {
                    "MutationObserver"in t && (T = new MutationObserver(function () {
                        k.debug("DOM tree modified, refreshing"), k.refresh()
                    }), T.observe(q, {childList: !0, subtree: !0}), k.debug("Setting up mutation observer", T))
                }, refresh: function () {
                    k.remove.scrolling(), k.cacheSizes(), k.set.screenHeight(), k.set.type(), k.set.position()
                }, refreshModals: function () {
                    v = O.siblings(z.modal), r = v.add(O)
                }, attachEvents: function (t, n) {
                    var i = e(t);
                    n = e.isFunction(k[n]) ? k[n] : k.toggle, i.size() > 0 ? (k.debug("Attaching modal events to element", t, n), i.off(F).on("click" + F, n)) : k.error(E.notFound, t)
                }, bind: {
                    events: function () {
                        j.on("click" + F, k.event.close), s.on("resize" + w, k.event.resize)
                    }
                }, get: {
                    uniqueID: function () {
                        return (Math.random().toString(16) + "000000000").substr(2, 8)
                    ...
                    close: function () {
                        k.verbose("Closing element pressed"), e(this).is(z.approve) ? e.proxy(S.onApprove, q)() !== !1 ? k.hide() : k.verbose("Approve callback returned false cancelling hide") : e(this).is(z.deny) ? e.proxy(S.onDeny, q)() !== !1 ? k.hide() : k.verbose("Deny callback returned false cancelling hide") : k.hide()
                    }, click: function (t) {
                        0 === e(t.target).closest(O).size() && (k.debug("Dimmer clicked, hiding all modals"), k.is.active() && (k.remove.clickaway(), S.allowMultiple ? k.hide() : k.hideAll()))
                        ...
                        y.dimmer("is active") && b(k.refresh)
                    }
                }, toggle: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, k.is.animating() || !k.is.active() ? (k.showDimmer(), k.cacheSizes(), k.set.position(), k.set.screenHeight(), k.set.type(), k.set.clickaway(), !S.allowMultiple && v.filter(":visible").size() > 0 ? (k.debug("Other modals visible, queueing show animation"), k.hideOthers(k.showModal)) : (e.proxy(S.onShow, q)(), S.transition && e.fn.transition !== i && O.transition("is supported") ? (k.debug("Showing modal with css animations"), O.transition({
                        debug: S.debug,
                        ...
                        useFailSafe: !0,
                        onComplete: function () {
                            e.proxy(S.onVisible, q)(), k.add.keyboardShortcuts(), k.save.focus(), k.set.active(), k.set.autofocus(), t()
                        }
                    })) : (k.debug("Showing modal with javascript"), O.fadeIn(S.duration, S.easing, function () {
                        e.proxy(S.onVisible, q)(), k.add.keyboardShortcuts(), k.save.focus(), k.set.active(), t()
                    })))) : k.debug("Modal is already visible")
                }, hideModal: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, k.debug("Hiding modal"), e.proxy(S.onHide, q)(), (k.is.animating() || k.is.active()) && (S.transition && e.fn.transition !== i && O.transition("is supported") ? (k.remove.active(), O.transition({
                        debug: S.debug,
                        ...
                        onComplete: function () {
                            e.proxy(S.onHidden, q)(), k.restore.focus(), t()
                        }
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, r.is(":visible") && (k.debug("Hiding all visible modals"), k.hideDimmer(), r.filter(":visible").modal("hide modal", t))
                }, hideOthers: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, v.is(":visible") && (k.debug("Hiding other modals", v), v.filter(":visible").modal("hide modal", t))
                }, othersActive: function () {
                    return v.filter("." + A.active).size() > 0
                }, add: {
                    keyboardShortcuts: function () {
                        k.verbose("Adding keyboard shortcuts"), c.on("keyup" + F, k.event.keyboard)
                    }
                }, save: {
                    focus: function () {
                    ...
                    active: function () {
                        ...
                        k.verbose("Removing keyboard shortcuts"), c.off("keyup" + F)
                    }, scrolling: function () {
                        y.removeClass(A.scrolling), O.removeClass(A.scrolling)
                    }
                }, cacheSizes: function () {
                    var o = O.outerHeight();
                    ...
                    autofocus: function () {
                        if (S.autofocus) {
                            var e = O.find(":input:visible"), t = e.filter("[autofocus]"), n = t.size() > 0 ? t : e;
                            n.first().focus()
                        }
                    }, clickaway: function () {
                        ...
                        y.addClass(A.scrolling), O.addClass(A.scrolling)
                    }, type: function () {
    ...
    e.fn.popup = function (o) {
        ...
        return r.each(function () {
            var n, r, g, p = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.popup.settings, o) : e.extend({}, e.fn.popup.settings), b = p.selector, v = p.className, h = p.error, y = p.metadata, x = p.namespace, w = "." + p.namespace, C = "module-" + x, T = e(this), k = e(p.context), S = p.target ? e(p.target) : T, z = e(t), A = e("body"), P = 0, E = !1, F = this, D = T.data(C);
            g = {
                initialize: function () {
                    g.debug("Initializing module", T), g.refresh(), "click" == p.on ? T.on("click" + w, g.toggle) : g.get.startEvent() && T.on(g.get.startEvent() + w, g.event.start).on(g.get.endEvent() + w, g.event.end), p.target && g.debug("Target set to element", S), z.on("resize" + w, g.event.resize), g.exists() ? p.hoverable && g.bind.popup() : g.create(), g.instantiate()
                }, instantiate: function () {
                    g.verbose("Storing instance of module", g), D = g, T.data(C, D)
                }, refresh: function () {
                    p.popup ? n = e(p.popup) : p.inline && (n = S.next(p.selector.popup)), p.popup ? (n.addClass(v.loading), r = T.offsetParent(), n.offsetParent()[0] !== r[0] && (g.debug("Moving popup to the same offset parent as activating element"), n.detach().appendTo(r)), n.removeClass(v.loading)) : r = p.inline ? S.offsetParent() : A, r.is("html") && (g.debug("Page is popups offset parent"), r = A)
                }, reposition: function () {
                    ...
                    return n ? p.inline || p.popup ? g.has.popup() : n.closest(k).size() > 1 ? !0 : !1 : !1
                }, removePopup: function () {
                    g.debug("Removing popup", n), g.has.popup() && n.remove(), e.proxy(p.onRemove, n)(F)
                }, save: {
                    conditions: function () {
                    ...
                    position: function (o, a) {
                        var s, c, l = (e(t).width(), e(t).height(), S.outerWidth()), u = S.outerHeight(), d = n.outerWidth(), m = n.outerHeight(), f = r.outerWidth(), b = r.outerHeight(), x = p.distanceAway, w = S[0], C = p.inline ? parseInt(t.getComputedStyle(w).getPropertyValue("margin-top"), 10) : 0, k = p.inline ? parseInt(t.getComputedStyle(w).getPropertyValue("margin-left"), 10) : 0, z = p.inline || p.popup ? S.position() : S.offset();
                        switch (o = o || T.data(y.position) || p.position, a = a || T.data(y.offset) || p.offset, P == p.maxSearchDepth && p.lastResort && (g.debug("Using last resort position to display", p.lastResort), o = p.lastResort), p.inline && (g.debug("Adding targets margin to calculation"), "left center" == o || "right center" == o ? (a += C, x += -k) : "top left" == o || "top center" == o || "top right" == o ? (a += k, x -= C) : (a += k, x += C)), g.debug("Calculating popup positioning", o), o) {
                            case"top left":
                                s = {top: "auto", bottom: b - z.top + x, left: z.left + a, right: "auto"};
                                break;
                            case"top center":
                                s = {
                                    bottom: b - z.top + x,
                                    left: z.left + l / 2 - d / 2 + a,
                                    top: "auto",
                                    right: "auto"
                                };
                                break;
                            case"top right":
                                s = {bottom: b - z.top + x, right: f - z.left - l - a, top: "auto", left: "auto"};
                                break;
                            case"left center":
                                s = {
                                    top: z.top + u / 2 - m / 2 + a,
                            ...
                            case"right center":
                                ...
                                break;
                            case"bottom left":
                                s = {top: z.top + u + x, left: z.left + a, bottom: "auto", right: "auto"};
                                break;
                            case"bottom center":
                                s = {
                                    top: z.top + u + x,
                                ...
                                break;
                            case"bottom right":
                                s = {top: z.top + u + x, right: f - z.left - l - a, left: "auto", bottom: "auto"}
                        }
                        if (s === i && g.error(h.invalidPosition, o), g.debug("Calculated popup positioning values", s), n.css(s).removeClass(v.position).addClass(o).addClass(v.loading), c = g.get.offstagePosition(o)) {
    ...
    e.fn.progress = function (t) {
        var o, a = e(this), r = a.selector || "", s = (new Date).getTime(), c = [], l = arguments[0], u = "string" == typeof l, d = [].slice.call(arguments, 1);
        return a.each(function () {
            var a, m, f = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.progress.settings, t) : e.extend({}, e.fn.progress.settings), g = f.className, p = f.metadata, b = f.namespace, v = f.selector, h = f.error, y = "." + b, x = "module-" + b, w = e(this), C = e(this).find(v.bar), T = e(this).find(v.progress), k = e(this).find(v.label), S = this, z = w.data(x), A = !1;
            m = {
                initialize: function () {
                    m.debug("Initializing progress bar", f), a = m.get.transitionEnd(), m.read.metadata(), m.set.duration(), m.set.initials(), m.instantiate()
                }, instantiate: function () {
                    m.verbose("Storing instance of progress", m), z = m, w.data(x, m)
                }, destroy: function () {
                    m.verbose("Destroying previous progress for", w), clearInterval(z.interval), m.remove.state(), w.removeData(x), z = i
                }, reset: function () {
                    m.set.percent(0)
                }, complete: function () {
                    ...
                    text: function (e) {
                        var t = m.value || 0, n = m.total || 0, i = m.is.visible() && A ? m.get.displayPercent() : m.percent || 0;
                        return e = e || "", e = e.replace("{value}", t).replace("{total}", n).replace("{percent}", i), m.debug("Adding variables to progress bar text", e), e
                    ...
                    barWidth: function (e) {
                        e > 100 ? m.error(h.tooHigh, e) : 0 > e ? m.error(h.tooLow, e) : (C.css("width", e + "%"), w.attr("data-percent", parseInt(e, 10)))
                    }, duration: function (e) {
                        ...
                        clearInterval(m.interval), C.one(a + y, function () {
                            m.verbose("Bar finished animating, removing continuous label updates"), clearInterval(m.interval), A = !1, m.set.labels()
                        }), A = !0, m.interval = setInterval(m.set.labels, f.framerate)
                    }, labels: function () {
                        ...
                        n === !1 && m.error(h.nonNumeric, e), m.total ? (m.value = n, t = n / m.total * 100, m.debug("Calculating percent complete from total", t), m.set.percent(t)) : (t = n, m.debug("Setting value to exact percentage value", t), m.set.percent(t))
                    }
                }, setting: function (t, n) {
                    if (m.debug("Changing setting", t, n), e.isPlainObject(t))e.extend(!0, f, t); else {
                        if (n === i)return f[t];
    ...
    e.fn.shape = function (o) {
        ...
        return r.each(function () {
            var t, f, g, p = r.selector || "", b = e.extend(!0, {}, e.fn.shape.settings, o), v = b.namespace, h = b.selector, y = b.error, x = b.className, w = "." + v, C = "module-" + v, T = e(this), k = T.find(h.sides), S = T.find(h.side), z = !1, A = this, P = T.data(C);
            g = {
                initialize: function () {
                    g.verbose("Initializing module for", A), g.set.defaultSide(), g.instantiate()
                }, instantiate: function () {
                    g.verbose("Storing instance of module", g), P = g, T.data(C, P)
                }, destroy: function () {
                    g.verbose("Destroying previous module for", A), T.removeData(C).off(w)
                }, refresh: function () {
                    g.verbose("Refreshing selector cache for", A), T = e(A), k = e(this).find(h.shape), S = e(this).find(h.side)
                }, repaint: function () {
                    ...
                    defaultSide: function () {
                        t = T.find("." + b.className.active), f = t.next(h.side).size() > 0 ? t.next(h.side) : T.find(h.side).first(), z = !1, g.verbose("Active side set to", t), g.verbose("Next side set to", f)
                    }, duration: function (e) {
                        ...
                        var e = T.clone().addClass(x.loading), t = e.find("." + b.className.active), n = z ? e.find(h.side).eq(z) : t.next(h.side).size() > 0 ? t.next(h.side) : e.find(h.side).first(), i = {};
                        ...
                        z = e, f = S.filter(e), z = S.index(f), 0 === f.size() && (g.set.defaultSide(), g.error(y.side)), g.verbose("Next side manually set to", f)
                    }, active: function () {
                    ...
                    var r, s, c, l = P;
                    return n = n || d, o = A || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
                            if (!e.isPlainObject(l[o]) || n == r)return l[o] !== i ? (s = l[o], !1) : !1;
    ...
    e.fn.sidebar = function (o) {
        var a, r = e(this), s = e(t), c = e(n), l = e("html"), u = e("head"), d = r.selector || "", m = (new Date).getTime(), f = [], g = arguments[0], p = "string" == typeof g, b = [].slice.call(arguments, 1), v = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function (e) {
                setTimeout(e, 0)
            };
        return r.each(function () {
            var r, h, y, x, w, C, T = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings), k = T.selector, S = T.className, z = T.namespace, A = T.regExp, P = T.error, E = "." + z, F = "module-" + z, D = e(this), O = e(T.context), R = D.children(k.sidebar), j = O.children(k.pusher), q = this, N = D.data(F);
            C = {
                initialize: function () {
                    C.debug("Initializing sidebar", o), C.create.id(), w = C.get.transitionEvent(), ("auto" == T.useLegacy && C.is.legacy() || T.useLegacy === !0) && (T.transition = "overlay", T.useLegacy = !0), C.is.ios() && C.set.ios(), v(C.setup.layout), C.instantiate()
                }, instantiate: function () {
                    C.verbose("Storing instance of module", C), N = C, D.data(F, C)
                }, create: {
                    id: function () {
                        C.verbose("Creating unique id for element"), y = C.get.uniqueID(), h = "." + y
                    }
                }, destroy: function () {
                    C.verbose("Destroying previous module for", D), C.remove.direction(), D.off(E).removeData(F), O.off(h), s.off(h), c.off(h)
                }, event: {
                    clickaway: function (t) {
                        0 === e(t.target).closest(k.sidebar).size() && (C.verbose("User clicked on dimmed page"), C.hide())
                    }, touch: function () {
                        ...
                        0 === e(t.target).closest(k.sidebar).size() && t.preventDefault()
                    }
                }, bind: {
                    clickaway: function () {
                        C.verbose("Adding clickaway events to context", O), T.closable && O.on("click" + h, C.event.clickaway).on("touchend" + h, C.event.clickaway)
                    }, scrollLock: function () {
                        T.scrollLock && (C.debug("Disabling page scroll"), s.on("DOMMouseScroll" + h, C.event.scroll)), C.verbose("Adding events to contain sidebar scroll"), c.on("touchmove" + h, C.event.touch), D.on("scroll" + E, C.event.containScroll)
                    }
                }, unbind: {
                    clickaway: function () {
                        C.verbose("Removing clickaway events from context", O), O.off(h)
                    }, scrollLock: function () {
                        C.verbose("Removing scroll lock from page"), c.off(h), s.off(h), D.off("scroll" + E)
                    }
                }, add: {
                    bodyCSS: function () {
                        var t, n = D.outerWidth(), i = D.outerHeight();
                        t = '<style title="' + z + '"> .ui.visible.left.sidebar ~ .fixed, .ui.visible.left.sidebar ~ .pusher {   -webkit-transform: translate3d(' + n + "px, 0, 0);           transform: translate3d(" + n + "px, 0, 0); } .ui.visible.right.sidebar ~ .fixed, .ui.visible.right.sidebar ~ .pusher {   -webkit-transform: translate3d(-" + n + "px, 0, 0);           transform: translate3d(-" + n + "px, 0, 0); } .ui.visible.left.sidebar ~ .ui.visible.right.sidebar ~ .fixed, .ui.visible.left.sidebar ~ .ui.visible.right.sidebar ~ .pusher, .ui.visible.right.sidebar ~ .ui.visible.left.sidebar ~ .fixed, .ui.visible.right.sidebar ~ .ui.visible.left.sidebar ~ .pusher {   -webkit-transform: translate3d(0px, 0, 0);           transform: translate3d(0px, 0, 0); } .ui.visible.top.sidebar ~ .fixed, .ui.visible.top.sidebar ~ .pusher {   -webkit-transform: translate3d(0, " + i + "px, 0);           transform: translate3d(0, " + i + "px, 0); } .ui.visible.bottom.sidebar ~ .fixed, .ui.visible.bottom.sidebar ~ .pusher {   -webkit-transform: translate3d(0, -" + i + "px, 0);           transform: translate3d(0, -" + i + "px, 0); }", C.is.ie() && (t += " .ui.visible.left.sidebar ~ .pusher:after {   -webkit-transform: translate3d(" + n + "px, 0, 0);           transform: translate3d(" + n + "px, 0, 0); } .ui.visible.right.sidebar ~ .pusher:after {   -webkit-transform: translate3d(-" + n + "px, 0, 0);           transform: translate3d(-" + n + "px, 0, 0); } .ui.visible.left.sidebar ~ .ui.visible.right.sidebar ~ .pusher:after, .ui.visible.right.sidebar ~ .ui.visible.left.sidebar ~ .pusher:after {   -webkit-transform: translate3d(0px, 0, 0);           transform: translate3d(0px, 0, 0); } .ui.visible.top.sidebar ~ .pusher:after {   -webkit-transform: translate3d(0, " + i + "px, 0);           transform: translate3d(0, " + i + "px, 0); } .ui.visible.bottom.sidebar ~ .pusher:after {   -webkit-transform: translate3d(0, -" + i + "px, 0);           transform: translate3d(0, -" + i + "px, 0); }"), t += "</style>", u.append(t), r = e("style[title=" + z + "]"), C.debug("Adding sizing css to head", r)
                    }
                }, refresh: function () {
                    C.verbose("Refreshing selector cache"), O = e(T.context), R = O.children(k.sidebar), j = O.children(k.pusher)
                }, refreshSidebars: function () {
                    C.verbose("Refreshing other sidebars"), R = O.children(k.sidebar)
                }, repaint: function () {
                    C.verbose("Forcing repaint event"), q.style.display = "none", q.offsetHeight, q.scrollTop = q.scrollTop, q.style.display = ""
                }, setup: {
                    layout: function () {
                        0 === O.children(k.pusher).size() && (C.debug("Adding wrapper element for sidebar"), C.error(P.pusher), j = e('<div class="pusher" />'), O.children().not(k.omitted).not(R).wrapAll(j), C.refresh()), (0 === D.nextAll(k.pusher).size() || D.nextAll(k.pusher)[0] !== j[0]) && (C.debug("Moved sidebar to correct parent element"), C.error(P.movedSidebar, q), D.detach().prependTo(O), C.refresh()), C.set.pushable(), C.set.direction()
                    }
                }, attachEvents: function (t, n) {
                    var i = e(t);
                    n = e.isFunction(C[n]) ? C[n] : C.toggle, i.size() > 0 ? (C.debug("Attaching sidebar events to element", t, n), i.on("click" + E, n)) : C.error(P.notFound, t)
                }, show: function (t) {
                    var n = T.useLegacy === !0 ? C.legacyPushPage : C.pushPage;
                    t = e.isFunction(t) ? t : function () {
                    }, C.is.hidden() ? (C.refreshSidebars(), T.overlay && (C.error(P.overlay), T.transition = "overlay"), C.refresh(), C.othersVisible() && "overlay" != C.get.transition() && (C.debug("Other sidebars currently open"), T.exclusive && C.hideOthers()), n(function () {
                        e.proxy(t, q)(), e.proxy(T.onShow, q)()
                    }), e.proxy(T.onChange, q)(), e.proxy(T.onVisible, q)()) : C.debug("Sidebar is already visible")
                }, hide: function (t) {
                    ...
                    t = e.isFunction(t) ? t : function () {
                        ...
                        e.proxy(t, q)(), e.proxy(T.onHidden, q)()
                    }), e.proxy(T.onChange, q)(), e.proxy(T.onHide, q)())
                }, othersVisible: function () {
                    return R.not(D).filter("." + S.visible).size() > 0
                }, hideOthers: function (e) {
                    var t = R.not(D).filter("." + S.visible), e = e || function () {
                        }, n = t.size(), i = 0;
                    ...
                    var n, i, o = C.get.transition(), a = "safe" == o ? O : "overlay" == o || C.othersVisible() ? D : j;
                    t = e.isFunction(t) ? t : function () {
                    }, "scale down" == T.transition && C.scrollToTop(), C.set.transition(), C.repaint(), n = function () {
                        C.bind.clickaway(), C.add.bodyCSS(), C.set.animating(), C.set.visible(), C.othersVisible() || T.dimPage && j.addClass(S.dimmed)
                    }, i = function (n) {
                        n.target == a[0] && (a.off(w + h, i), C.remove.animating(), C.bind.scrollLock(), e.proxy(t, q)())
                    }, a.off(w + h), a.on(w + h, i), v(n)
                }, pullPage: function (t) {
                    var n, i, o = C.get.transition(), a = "safe" == o ? O : "overlay" == o || C.othersVisible() ? D : j;
                    t = e.isFunction(t) ? t : function () {
                    }, C.verbose("Removing context push state", C.get.direction()), C.unbind.clickaway(), C.unbind.scrollLock(), n = function () {
                        C.set.animating(), C.remove.visible(), T.dimPage && !C.othersVisible() && j.removeClass(S.dimmed)
                    }, i = function (n) {
                        n.target == a[0] && (a.off(w + h, i), C.remove.animating(), C.remove.transition(), C.remove.bodyCSS(), ("scale down" == o || T.returnScroll && C.is.mobile()) && C.scrollBack(), e.proxy(t, q)())
                    }, a.off(w + h), a.on(w + h, i), v(n)
                }, legacyPushPage: function (t) {
                    var n = D.width(), i = C.get.direction(), o = {};
                    n = n || D.width(), t = e.isFunction(t) ? t : function () {
                    }, o[i] = n, C.debug("Using javascript to push context", o), C.set.visible(), C.set.transition(), C.set.animating(), T.dimPage && j.addClass(S.dimmed), O.css("position", "relative").animate(o, T.duration, T.easing, function () {
                        C.remove.animating(), C.bind.clickaway(), e.proxy(t, C)()
                    })
                }, legacyPullPage: function (t) {
                    var n = 0, i = C.get.direction(), o = {};
                    n = n || D.width(), t = e.isFunction(t) ? t : function () {
                    }, o[i] = "0px", C.debug("Using javascript to pull context", o), C.unbind.clickaway(), C.set.animating(), C.remove.visible(), T.dimPage && !C.othersVisible() && j.removeClass(S.dimmed), O.css("position", "relative").animate(o, T.duration, T.easing, function () {
                        C.remove.animating(), e.proxy(t, C)()
                    })
                    ...
                    bodyCSS: function () {
                        C.debug("Removing body css styles", r), r.size() > 0 && r.remove()
                    }, pushed: function () {
                    ...
                    ie: function () {
                        ...
                        var e = navigator.userAgent, t = A.ios.test(e);
                        return t ? (C.verbose("Browser was found to be iOS", e), !0) : !1
                    }, mobile: function () {
                        var e = navigator.userAgent, t = A.mobile.test(e);
                    ...
                    var r, s, c, l = N;
                    return n = n || b, o = q || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
        ...
        return a.each(function () {
            ...
            f = {
                initialize: function () {
                    ...
                    f.verbose("Destroying previous module"), f.reset(), m && m.disconnect(), w.off("resize" + h, f.event.resize), T.off("scroll" + h, f.event.scroll), x.removeData(y)
                }, observeChanges: function () {
                    var e = a[0];
                    ...
                    }), m.observe(z, {childList: !0, subtree: !0}), m.observe(e, {
                        childList: !0,
                        subtree: !0
                    ...
                    resize: function () {
                        ...
                        S(function () {
                            f.stick(), e.proxy(g.onScroll, z)()
                        })
                    }
                }, refresh: function (t) {
                    f.reset(), t && (C = x.offsetParent()), f.save.positions(), f.stick(), e.proxy(g.onReposition, z)()
                }, supports: {
                    sticky: function () {
                        {
                            var t = e("<div/>");
                    ...
                    f.debug("Binding element to top of parent container"), f.remove.offset(), x.css("left", "").css("top", "").css("bottom", "").removeClass(p.fixed).removeClass(p.bottom).addClass(p.bound).addClass(p.top), e.proxy(g.onTop, z)(), e.proxy(g.onUnstick, z)()
                }, bindBottom: function () {
                    f.debug("Binding element to bottom of parent container"), f.remove.offset(), x.css("left", "").css("top", "").css("bottom", "").removeClass(p.fixed).removeClass(p.top).addClass(p.bound).addClass(p.bottom), e.proxy(g.onBottom, z)(), e.proxy(g.onUnstick, z)()
                }, setInitialPosition: function () {
                    f.unfix(), f.unbind()
                }, fixTop: function () {
                    f.debug("Fixing element to top of page"), f.set.offset(), x.css("left", f.cache.element.left).removeClass(p.bound).removeClass(p.bottom).addClass(p.fixed).addClass(p.top), e.proxy(g.onStick, z)()
                }, fixBottom: function () {
                    f.debug("Sticking element to bottom of page"), f.set.offset(), x.css("left", f.cache.element.left).removeClass(p.bound).removeClass(p.top).addClass(p.fixed).addClass(p.bottom), e.proxy(g.onStick, z)()
                }, unbind: function () {
                    ...
                    var r, s, c, l = k;
                    return n = n || d, a = z || a, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
                            if (!e.isPlainObject(l[o]) || n == r)return l[o] !== i ? (s = l[o], !1) : !1;
    ...
    e.fn.tab = function (n) {
        ...
        return r.each(function () {
            var n, g, p, b, v, h = s.className, y = s.metadata, x = s.selector, w = s.error, C = "." + s.namespace, T = "module-" + s.namespace, k = e(this), S = {}, z = !0, A = 0, P = this, E = k.data(T);
            o = {
                initialize: function () {
                    ...
                    o.verbose("Storing instance of module", o), E = o, k.data(T, o)
                }, destroy: function () {
                    ...
                    var a = t.history && t.history.pushState, r = a && s.ignoreFirstLoad && z, c = s.auto || e.isPlainObject(s.apiSettings), l = c && !r ? o.utilities.pathToArray(i) : o.get.defaultPathArray(i);
                    i = o.utilities.arrayToPath(l), e.each(l, function (t, a) {
                        ...
                        if (o.verbose("Looking for tab", a), y) {
                            ...
                            if (-1 != i.search("/") || "" === i)return o.error(w.missingTab, k, n, h), !1;
                    ...
                    initialPath: function () {
                        ...
                        if (n) {
                            if (o.debug("Found default tab", n), A < s.maxDepth)return A++, o.get.defaultPath(n);
                            o.error(w.recursion)
    ...
    e.fn.video = function (n) {
        ...
        return a.each(function () {
            var m, f = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.video.settings, n) : e.extend({}, e.fn.video.settings), g = f.selector, p = f.className, b = f.error, v = f.metadata, h = f.namespace, y = f.templates, x = "." + h, w = "module-" + h, C = (e(t), e(this)), T = C.find(g.placeholder), k = C.find(g.playButton), S = C.find(g.embed), z = this, A = C.data(w);
            m = {
                initialize: function () {
                    m.debug("Initializing video"), m.create(), T.on("click" + x, m.play), k.on("click" + x, m.play), m.instantiate()
                }, instantiate: function () {
                    m.verbose("Storing instance of module", m), A = m, C.data(w, m)
                }, create: function () {
    ...
    e.api = e.fn.api = function (n) {
        ...
        return a.each(function () {
            var t, a, m, f, g, p = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.api.settings, n) : e.extend({}, e.fn.api.settings), b = p.namespace, v = (p.metadata, p.selector), h = p.error, y = p.className, x = "." + b, w = "module-" + b, C = e(this), T = C.closest(v.form), k = p.stateContext ? e(p.stateContext) : C, S = this, z = k.get(), A = C.data(w);
            g = {
                initialize: function () {
                    var e = g.get.event();
                    u || (e ? (g.debug("Attaching API events to element", e), C.on(e + x, g.event.trigger)) : g.query()), g.instantiate()
                }, instantiate: function () {
                    g.verbose("Storing instance of module", g), A = g, C.data(w, A)
                }, destroy: function () {
                    ...
                    trigger: function (e) {
                        ...
                        complete: function (t) {
                            g.remove.loading(), e.proxy(p.onComplete, z)(t, C)
                        }, done: function (t) {
                            g.debug("API Response Received", t), "json" == p.dataType && e.isFunction(p.successTest) ? (g.debug("Checking JSON returned success", p.successTest, t), p.successTest(t) ? e.proxy(p.onSuccess, z)(t, C) : (g.debug("JSON test specified by user and response failed", t), e.proxy(p.onFailure, z)(t, C))) : e.proxy(p.onSuccess, z)(t, C)
                            ...
                            if (t !== i)if (t.readyState !== i && 4 == t.readyState) {
                                ...
                                g.remove.loading(), g.set.error(), p.errorDuration && setTimeout(g.remove.error, p.errorDuration), g.debug("API Request error:", r), e.proxy(p.onError, z)(r, z)
                            } else e.proxy(p.onAbort, z)(r, z), g.debug("Request Aborted (Most likely caused by page change or CORS Policy)", n, o)
                        }
                    }
                }, create: {
                    request: function () {
            ...
            }, u ? (A === i && g.initialize(), g.invoke(l)) : (A !== i && g.destroy(), g.initialize())
        }), o !== i ? o : this
    }, e.api.settings = {
        name: "API",
        namespace: "api",
    ...
    e.fn.visibility = function (o) {
        ...
        return r.each(function () {
            var r, f = e.extend(!0, {}, e.fn.visibility.settings, o), g = f.className, p = f.namespace, b = f.error, v = "." + p, h = "module-" + p, y = e(t), x = e(this), w = e(f.context), C = (x.offsetParent(), x.selector || "", x.data(h)), T = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function (e) {
                    setTimeout(e, 0)
                }, k = this;
            r = {
                initialize: function () {
                    ...
                    r.verbose("Storing instance of module", r), C = r, x.data(h, r)
                }, destroy: function () {
                    r.verbose("Destroying previous module"), x.off(v).removeData(h)
                }, bindEvents: function () {
                    ...
                    cache: function () {
                        ...
                        r.verbose("Setting up fixed on element pass"), x.visibility({
                            ...
                            onTopPassedReverse: function () {
                                x.removeClass(g.fixed).css({position: "", top: ""})
                            }
                        })
                    }
                }, set: {
                    ...
                    r.debug("Refreshing constants (element width/height)"), r.reset(), r.save.position(), r.checkVisibility(), e.proxy(f.onRefresh, k)()
                }, reset: function () {
                    ...
                    t = t || !1, t && (f.continuous ? (r.debug("Callback being called continuously", n, i), e.proxy(t, k)(i, o)) : r.get.occurred(n) || (r.debug("Conditions met", n, i), e.proxy(t, k)(i, o))), r.save.occurred(n)
                }, remove: {
                    occurred: function (e) {
                    ...
                    calculations: function () {
                        ...
                        r.verbose("Saving window position"), r.cache.screen = {height: w.height()}
                    }, position: function () {
                    ...
                    return n = n || m, o = k || o, "string" == typeof t && u !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (n, o) {
                        ...
                        if (e.isPlainObject(u[a]) && n != s)u = u[a]; else {
                            if (u[a] !== i)return c = u[a], !1;
                            if (!e.isPlainObject(u[o]) || n == s)return u[o] !== i ? (c = u[o], !1) : (r.error(b.method, t), !1);
                            u = u[o]
                        }
