        ...
        return o.each(function () {
            ...
            v = {
                initialize: function () {
                    ...
                    text: function (e) {
                        var t = v.value || 0, n = v.total || 0, r = v.is.visible() && I ? v.get.displayPercent() : v.percent || 0;
                        return e = e || "", e = e.replace("{value}", t).replace("{total}", n).replace("{percent}", r), v.debug("Adding variables to progress bar text", e), e
            ...
            }, u ? (S === r && v.initialize(), v.invoke(l)) : (S !== r && v.destroy(), v.initialize())
        }), a !== r ? a : this
